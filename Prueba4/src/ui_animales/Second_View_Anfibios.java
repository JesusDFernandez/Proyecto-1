package ui_animales;
   ...
   public class Second_View_Anfibios extends JFrame {
      ...
      public Second_View_Anfibios() {
       ...
       public void cargardatos(){
         ...
         try {
            ...
            ResultSet  result= stmt.executeQuery("select * from anfibios");
       ...
       public void busqueda(String nombre_categ) {
         try {
            ...
            modelo.setRowCount(0);
            ResultSet rs = s.executeQuery("select * from anfibios where nombrecomun like '%"+nombre_categ+"%'");
