	...
	public Third_View_Mamiferos() {
		...
		modificar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				for (int i = 0; i < Lista_Mamiferos.getInstances().getLista().size(); i++) {
					if (c.equalsIgnoreCase(Lista_Mamiferos.getInstances().getLista().get(i).getNombrecomun())) {

						Lista_Mamiferos.getInstances().getLista().get(i).setEdad(tfEdad.getText());
						Lista_Mamiferos.getInstances().getLista().get(i).setNombrecientifico(tfNombrecientifico.getText());
						Lista_Mamiferos.getInstances().getLista().get(i).setNombrecomun(tfNombrecomun.getText());
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				for (int i = 0; i < Lista_Mamiferos.getInstances().getLista().size(); i++) {
					if (c.equalsIgnoreCase(Lista_Mamiferos.getInstances().getLista().get(i).getNombrecomun())) {
						...
						Lista_Mamiferos.getInstances().getLista().remove(i);
				...
				if(tfBuscar.getText().isEmpty()) {
					...
					for (int i = 0; i < Lista_Mamiferos.getInstances().getLista().size(); i++) {
						if (c.equalsIgnoreCase(Lista_Mamiferos.getInstances().getLista().get(i).getNombrecomun())) {
							...
							tfEdad.setText(Lista_Mamiferos.getInstances().getLista().get(i).getEdad());
							tfNombrecientifico.setText(Lista_Mamiferos.getInstances().getLista().get(i).getNombrecientifico());
							tfNombrecomun.setText(Lista_Mamiferos.getInstances().getLista().get(i).getNombrecomun());
