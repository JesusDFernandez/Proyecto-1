package ui_animales;
   ...
   public class Second_View_Reptiles extends JFrame {
      ...
      public Second_View_Reptiles() {
       ...
       public void cargardatos(){
         ...
         try {
            ...
            ResultSet  result= stmt.executeQuery("select * from reptiles");
       ...
       public void busqueda(String nombre_categ) {
         try {
            ...
            modelo.setRowCount(0);
            ResultSet rs = s.executeQuery("select * from reptiles where nombrecomun like '%"+nombre_categ+"%'");
